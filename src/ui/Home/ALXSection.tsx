...
const ALXSection: React.FC = () => {
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-white dark:bg-[#141414] relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          >
            ALX
            <br />
            <span className="text-[#9a6f00] dark:text-[#e9c766]">Professional Certification</span>
          </motion.h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-50 dark:from-[#141414] to-white dark:to-[#0d0d0f] rounded-3xl shadow-2xl p-8 lg:p-12 border border-gray-100 dark:border-white/10">
              ...
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 bg-gradient-to-r from-[#d4a017] to-[#b8860b] text-white rounded-full p-4 shadow-xl"
                >
              ...
              <div className="text-center mt-8">
                ...
                <p className="text-lg text-[#9a6f00] dark:text-[#e9c766] font-semibold">
